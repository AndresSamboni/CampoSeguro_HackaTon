const About = () => {
  return (
    <div className="flex flex-col items-center scroll-mt-8" id='nosotros'>

      <div className="flex flex-col w-10/12 ">
        <h1 className="text-5xl font-extrabold dark:text-white text-center mt-9 mb-5">Quienes Somos</h1>

        <p className="font-normal mb-9 text-justify">
        ...
        <h2 className="text-4xl font-bold dark:text-white mb-5">Misión: </h2>
        <p className="mb-9 text-justify font-normal">
        ...
        <h2 className="text-4xl font-bold dark:text-white mb-5">Visión: </h2>
        <p className="font-normal text-justify mb-9">
