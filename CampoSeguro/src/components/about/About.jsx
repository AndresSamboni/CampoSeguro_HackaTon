...
function About() {
  return (
    <div className="flex flex-col items-center bg-lightGray p-12 my-6" id='nosotros'>
      <div className="flex flex-col w-10/12">
        <h1 className="text-5xl font-extrabold text-darkText text-center mt-9 mb-5">Quiénes Somos</h1>

        <p className="font-normal mb-9 text-justify text-darkText">
        ...
        <h2 className="text-4xl font-bold text-primaryBlue mb-5">Misión:</h2>
        <p className="mb-9 text-justify font-normal text-darkText">
        ...
        <h2 className="text-4xl font-bold text-primaryBlue mb-5">Visión:</h2>
        <p className="font-normal text-justify mb-9 text-darkText">
